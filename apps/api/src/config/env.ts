...
const envSchema = z.object({
  ...
  JWT_ACCESS_SECRET: z.string().default('PayPilot_AccessKey_#98234_xZ9$qL!2026_Secured_a7b8c9d0'),
  JWT_REFRESH_SECRET: z.string().default('PayPilot_RefreshKey_@77192_mB8#vW%2026_Secured_e1f2g3h4'),
